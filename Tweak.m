...
- (void)doH4x {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        if (presented) {
            ...
            UITextView *compose  = [UITextView new];//(UITextView*)[visible.view findFirstSubviewWithClass: NSClassFromString(@"T1ComposeTextView")]; //is actually part of a child view controller a few layers deeper, this finds it easier!
